...
class ApiService(Base):
    ...
    endpoint_url: Mapped[str] = mapped_column(String(240), default="")
    expected_latency_ms: Mapped[float] = mapped_column(Float, default=250.0)
    timeout_threshold_ms: Mapped[float] = mapped_column(Float, default=2000.0)
